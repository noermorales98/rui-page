...
export function ModalWrapper({ onClose, children, title }: ModalWrapperProps) {
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-labelledby={titleId} className={`my-auto max-h-[90vh] w-[calc(100vw-2rem)] max-w-md overflow-y-auto overflow-x-hidden rounded-[28px] bg-[var(--color-surface-container-lowest)] p-5 sm:p-7`}>
