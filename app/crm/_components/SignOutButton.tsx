...
export default function SignOutButton() {
  return (
    <button
      ...
      className="flex min-h-10 w-full cursor-pointer items-center gap-2.5 rounded-full border-none bg-transparent px-3.5 py-2.5 font-sans text-[13.5px] font-medium text-[var(--color-on-surface-variant)] transition hover:bg-white hover:text-[var(--color-on-surface)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary-fixed-dim)]"
    >
