...
function SilhouetteArt() {
  return (
    ...
    >
      ...
      <ellipse cx="210" cy="340" rx="160" ry="28" fill="url(#sil-mist)" />
      <g fill="url(#sil-gold)" opacity="0.92">
        <path d="M72 310c0-48 18-92 28-120 10-28 22-42 38-42s28 14 38 42c10 28 28 72 28 120H72z" />
        <circle cx="138" cy="118" r="36" />
        <path d="M178 310c0-52 20-98 32-128 12-30 26-46 44-46s32 16 44 46c12 30 32 76 32 128H178z" />
        <circle cx="254" cy="108" r="40" />
        <path d="M288 310c0-44 16-86 26-114 10-28 24-44 40-44s30 16 40 44c10 28 26 70 26 114H288z" />
        <circle cx="354" cy="124" r="34" />
      </g>
      <path
