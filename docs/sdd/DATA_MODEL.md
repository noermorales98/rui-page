...
- `CrmFormFieldType`: SHORT_TEXT, FULL_NAME, PHONE, PHONE_WITH_COUNTRY, EMAIL, CUSTOM_DATE, CUSTOM_TIME, CUSTOM_DATETIME, **HTML_INPUT** (controles genéricos vía `config.html`).
